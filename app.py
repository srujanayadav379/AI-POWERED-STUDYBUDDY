...
if st.button("🚀 Generate Result"):
    ...
    if not text_input.strip():
        ...
        if mode == "Explain Concept":
            prompt = "Explain the following concept clearly and simply for a student:\n\n" + text_input

        elif mode == "Summarize Notes":
            prompt = "Summarize the following notes into key points and provide a short summary:\n\n" + text_input

        else:
            prompt = "Generate 5 quiz questions with answers based on the following content:\n\n" + text_input
        ...
        try:
            ...
            if "429" in error_msg:
                ...
                st.error("⚠️ Gemini service is busy. Please try again in a few minutes.")
